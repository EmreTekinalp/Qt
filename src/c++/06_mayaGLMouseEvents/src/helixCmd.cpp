...
HelixButton::HelixButton(QWidget* parent) : QMainWindow(parent)
{
    setupUi(this);
    connect(pushButton, SIGNAL(clicked()), this, SLOT(createHelix()));
    connect(pushButton_3, SIGNAL(clicked()), this, SLOT(buttonThree()));

    show();
}

void HelixButton::buttonOne()
{
    MGlobal::displayWarning("Create button clicked!");
}

void HelixButton::buttonTwo()
{
    MGlobal::displayWarning("Edit button clicked!");
}

void HelixButton::buttonThree()
{
    MGlobal::displayWarning("Close button clicked!");
}
...
const MString           HelixQtCmd::commandName("mayaGL");
